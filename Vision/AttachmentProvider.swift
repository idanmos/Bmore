...
class AttachmentProvider {
     ...
     */
    func addAttachment(imageData: Data, imageURL: URL, property: Property?, taskContext: NSManagedObjectContext,
    ...
    func deleteAttachment(_ attachment: Attachment, shouldSave: Bool = true) {
        ...
        context.performAndWait {
            attachment.property?.removeFromAttachments(attachment)
    ...
    /**
     ...
     Save to the store for synchronization only when the property is saved.
     */
