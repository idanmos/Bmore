...
class LocationPickerViewController: UIViewController {
    ...
    override func loadView() {
        ...
        NSLayoutConstraint.activate([
            ...
            stackView.leftAnchor.constraint(equalTo: self.view.safeAreaLayoutGuide.leftAnchor, constant: 0),
            stackView.rightAnchor.constraint(equalTo: self.view.safeAreaLayoutGuide.rightAnchor, constant: 0),
            stackView.bottomAnchor.constraint(equalTo: self.view.safeAreaLayoutGuide.bottomAnchor, constant: 0)
        ])
        
        stackView.addArrangedSubview(self.mapView)
...
extension LocationPickerViewController: MKMapViewDelegate {
    ...
    func mapView(_ mapView: MKMapView, didAdd views: [MKAnnotationView]) {
        let userAnnotations: [MKAnnotationView] = views.filter({ $0.annotation is MKUserLocation })
        userAnnotations.forEach({ $0.canShowCallout = false })
    }
